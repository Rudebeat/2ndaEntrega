...
let numeroRamdom = (parseInt(Math.ramdom() * 100)) + 1
...
while (numeroIngresado !== null && numeroIngresado !== NaN) {
    ...
    if (numeroIngresado === numeroramdom) {
        ...
        let numeroCaliente1 = numeroRamdom - 5;
        let numeroCaliente2 = numeroRamdom + 5;
        let numeroTibio1 = numeroRamdom - 5;
        let numeroTibio2 = numeroRamdom - 5;
        let numeroFrio1 = numeroRamdom - 5;
        let numeroFrio2 = numeroRamdom - 5;
